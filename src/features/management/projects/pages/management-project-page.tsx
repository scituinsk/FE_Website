...
import { GlobeIcon, Plus, ChevronDown, Lock, ArrowUpDown, ArrowUp, ArrowDown } from "lucide-react";
            ...
            <div className="flex flex-col">
              {projects.map((project) => (
                ...
                >
                  ...
                  >
                    <Popover
                      open={visibilityPopoverId === project.id}
                        ...
                        <div className="space-y-3">
                          ...
                          <div className="flex gap-2 justify-end">
                            <Button
                              size="sm"
                              variant="outline"
                              onClick={() => setVisibilityPopoverId(null)}
                            >
                              Batal
                            </Button>
                            <Button
                              ...
                              onClick={() => {
                                ...
                                const selectedValue = document.querySelector(`input[name="visibility-${project.id}"]:checked`) as HTMLInputElement;
                                console.log("Selected visibility:", selectedValue?.value);
